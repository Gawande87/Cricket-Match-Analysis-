...
data = {
        ...
        'Runs': [202,10,38,10,38,28,2,0,6,0,0],
        'Wickets': [0,0,0,0,0,1,0,1,5,1,1],
...
# Batting Strike Rate for Each Player
match_data['Batting Strike Rate'] = (match_data['Runs'] / (match_data['Balls Faced'] )* 100)
print("\nBatting Strike Rate:\n", match_data[['Player','Batting Strike Rate']])

# Economy Rate for Each Bowler
match_data['Bowler Economy Rate'] = match_data['Runs Conceded'] / (match_data['Balls Bowled'] )
print("\nBowler Economy Rate:\n", match_data[['Player','Bowler Economy Rate']])
